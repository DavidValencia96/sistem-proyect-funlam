                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <div class="alert alert-success text-center" id="add-prov" style="display:none">
                                <span><i class="fas fa-check mr-1"></i>Proyecto creado correctamente.</span>
                            </div>
                            <div class="alert alert-danger text-center" id="noadd-prov" style="display:none">
                                <span><i class="fas fa-times mr-1"></i>El proyecto ya exite.</span>
                            </div>
                            ...
                            <form id="form-crear">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" id="nombre" type="text" class="form-control" placeholder="Nombre del Proyecto" required>
                                </div>
                                <div class="form-group">
                                    <label for="descripcion">Descripción de proyecto</label>
                                ...
                                <input type="hidden" id="id_edit_proyect">
                        </div>
							...
							<!-- Content -->
								<section>
                                    ...
                                    <!-- Content -->
                                        <div>
                                            <h2 id="content"></h2>
                                                <p>Aquí puede agregar información relacionada a <a href="./proyectos.php">Proyectos</a>.</p>
										</div>
                                </section>
                                <section>
                                    <div class="container-fluid">
                                        <div class="card card-success">
                                            <div class="card-header">
                                                <h3 class="card-title">Buscar o <button type="button" data-toggle ="modal" data-target="#crearproveedor" class="btn primary  ml-2">Crear artículo</button></h3>
                                                <div class="input-group">
                                                    <input type="text" id="buscar_proveedor"class="form-control float-left" placeholder="Ingrese nombre del Proyecto">
                                            ...
                                            <div class="card-body">
                                                <div id="proyecto" class="row d-flex align-items-stretch">
