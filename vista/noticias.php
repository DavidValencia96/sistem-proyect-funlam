							...
							<!-- Content -->
								<section>
									<header class="main">
										...
										<h3 id="content">Aquí las noticias actuales:</h3>
										<div class="row">
												<?php 
													include_once('../modelo/Conexion2.php');
													//$resultado=$conexion->query("select * from noticias Order by fecha_subida desc");
													$resultado=$conexion->query("select id_noticia, nombre_noticia, descripcion_noticia, responsable, fecha_subida, nombres, apellidos  
													from noticias
												...
												<div class="col-6 col-12-small">
													<h4><b><?php echo $fila['nombre_noticia'];?></b></h4>
													<p ><?php 
															$cadena = $fila['descripcion_noticia'];
															if (strlen($cadena) > 1){
																
																echo nl2br(substr($cadena, 0 ,300) . '...');

															}
													?><a href="./info_noticias.php?id_noticia=<?php echo $fila['id_noticia'];?>">  Más Información.</a></p>
