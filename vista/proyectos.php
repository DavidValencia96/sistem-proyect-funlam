							...
							<!-- Content -->
								<section>
									<header class="main">
										...
										<h3 id="content">Aquí nuestros proyectos actuales:</h3>
										<div class="row">
												<?php 
													include_once('../modelo/Conexion2.php');
													$resultado=$conexion->query("select id_proyecto, nombre_proyecto, descripcion_proyecto, responsable, fecha_subida, nombres, apellidos  
													from proyectos
												...
												<div class="col-6 col-12-small">
													<h4><b><?php echo $fila['nombre_proyecto'];?></b></h4>
													<p ><?php
														$cadena = $fila['descripcion_proyecto'];
														if (strlen($cadena) > 1){
															echo nl2br(substr($cadena, 0 ,300) . '...');
														}
													?><a href="./info_proyectos.php?id_proyecto=<?php echo $fila['id_proyecto'];?>">   Más Información.</a></p>
