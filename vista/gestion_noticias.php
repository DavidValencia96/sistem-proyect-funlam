...
?>
	...
	<body class="is-preload">
        <!-- modal -->
        <div class="modal fade" id="crearnoticia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="card card-success">
                        <div class="card-header">
                            <h4 class="card-title">Gestión proyecto</h4>
                            
                        </div>
                        <div class="card-body">
                            <div class="alert alert-success text-center" id="add-prov" style="display:none">
                                <span><i class="fas fa-check mr-1"></i>Noticia creada correctamente.</span>
                            </div>
                            <div class="alert alert-danger text-center" id="noadd-prov" style="display:none">
                                <span><i class="fas fa-times mr-1"></i>La noticia ya exite.</span>
                            </div>
                            ...
                            <form id="form-crear">
                                <div class="form-group">
                                    <label for="nombre">Nombre noticia</label>
                                    <input autocomplete="off" id="nombre" type="text" class="form-control" placeholder="Nombre de la noticia" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="imagen" type="file" class="form-control" placeholder="Agrega una imagen" hidden disabled>
                                </div>
                                <div class="form-group">
                                    <label for="responsable"></label>
                                    <input id="responsable" type="text" class="form-control" value="<?php echo $_SESSION['usuario'];?> " placeholder="Ingrese su nombre completo" hidden disabled>
                                </div>
                                <input type="hidden" id="id_edit_noti">
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn primary small float-right m-1">Guardar noticia</button>
							...
							<!-- Content -->
								<section>
                                    ...
                                    <!-- Content -->
                                        <div>
                                            <h2 id="content"></h2>
                                                <p>Aquí puede agregar información relacionada a <a href="./noticias.php">noticias</a>.</p>
										</div>
                                </section>
                                <section>
                                    <div class="container-fluid">
                                        <div class="card card-success">
                                            <div class="card-header">
                                                <h3 class="card-title">Buscar o <button type="button" data-toggle ="modal" data-target="#crearnoticia" class="btn primary  ml-2">Crear artículo</button></h3>
                                                <div class="input-group">
                                                    <input type="text" id="buscar_noticias"class="form-control float-left" placeholder="Ingrese el nombre de la noticia">
                                            ...
                                            <div class="card-body">
                                                <div id="noticias" class="row d-flex align-items-stretch">
