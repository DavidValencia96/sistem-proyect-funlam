...
?>
	...
	<body class="is-preload">
        <!-- modal -->
        <div class="modal fade" id="crearpracticas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="card card-success">
                        <div class="card-header">
                            <h4 class="card-title">Gestión prácticas</h4>
                            
                        </div>
                        <div class="card-body">
                            <div class="alert alert-success text-center" id="add-prov" style="display:none">
                                <span><i class="fas fa-check mr-1"></i>prácticas creado correctamente.</span>
                            </div>
                            <div class="alert alert-danger text-center" id="noadd-prov" style="display:none">
                                <span><i class="fas fa-times mr-1"></i>La prácticas ya exite.</span>
                            </div>
                            ...
                            <form id="form-crear">
                                <div class="form-group">
                                    <label for="nombre">Nombre prácticas</label>
                                    <input autocomplete="off" id="nombre" type="text" class="form-control" placeholder="Nombre del prácticas" required>
                                </div>
                                <div class="form-group">
                                    <label for="descripcion">Descripción de prácticas</label>
                                ...
                                <input type="hidden" id="id_edit_practicss">
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn primary small float-right m-1">Guardar prácticas</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        <img id="logoactual"src="../images/practicas/location.png" class="profile-user-img img-fluid img-circle">
                    </div>
                    <div class="text-center">
                        <b id="nombre_logo"> </b>
                    </div>
							...
							<!-- Content -->
								<section>
                                    ...
                                    <!-- Content -->
                                        <div>
                                            <h2 id="content"></h2>
                                                <p>Aquí puede agregar información relacionada a <a href="./practicas.php">Prácticas</a>.</p>
										</div>
                                </section>
                                <section>
                                    <div class="container-fluid">
                                        <div class="card card-success">
                                            <div class="card-header">
                                                <h3 class="card-title">Buscar o <button type="button" data-toggle ="modal" data-target="#crearpracticas" class="btn primary  ml-2">Crear artículo</button></h3>
                                                <div class="input-group">
                                                    <input type="text" id="buscar_practicas"class="form-control float-left" placeholder="Ingrese el nombre de la práctica">
                                            ...
                                            <div class="card-body">
                                                <div id="practica" class="row d-flex align-items-stretch">
