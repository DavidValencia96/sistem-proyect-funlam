							...
							<!-- Content -->
								<section>
									<?php 
											...
											isset($_GET['id_noticia']);
											$resultado=$conexion->query("select id_noticia, nombre_noticia, imagen, descripcion_noticia, responsable, fecha_subida, nombres, apellidos, enlace_externo 
											from noticias
											join usuarios on nombres=nombres and  apellidos = apellidos and responsable = id_usuario where id_noticia='".$_GET['id_noticia']."';");
											if(mysqli_num_rows($resultado)>0){
												while ($fila = mysqli_fetch_array($resultado)) {
									?>
									<header class="main">
									<h2><a href="./noticias.php">Regresar a noticias</a></h2><hr>
									</header>
									<h3 id="content"><?php echo $fila['nombre_noticia'];?></h3>
										<div>
											<p><?php echo nl2br($fila['descripcion_noticia']); ?> 
                                            <br><br><a href="<?php echo $fila['enlace_externo'];?>" target="_blank">Más Información.</a></p>
											<img src="../images/noticias/<?php echo $fila['imagen'];?>" class="image img"  width="600px">
