...
?>
	...
	<body class="is-preload">
        <!-- modal -->
        <div class="modal fade" id="crearporta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="card card-success">
                        <div class="card-header">
                            <h4 class="card-title">Gestión portafolio</h4>
                            
                        </div>
                        <div class="card-body">
                            <div class="alert alert-success text-center" id="add-prov" style="display:none">
                                <span><i class="fas fa-check mr-1"></i>Portafolio creado correctamente.</span>
                            </div>
                            <div class="alert alert-danger text-center" id="noadd-prov" style="display:none">
                                <span><i class="fas fa-times mr-1"></i>El Portafolio ya exite.</span>
                            </div>
                            ...
                            <form id="form-crear">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" id="nombre" type="text" class="form-control" placeholder="Nombre del portafolio" required>
                                </div>
                                <div class="form-group">
                                    <label for="descripcion">Descripción de portafolio</label>
                                ...
                                <input type="hidden" id="id_edit_porta">
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn primary small float-right m-1">Guardar portafolio</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        <img id="logoactual"src="../images/portafolio/location.png" class="profile-user-img img-fluid img-circle">
                    </div>
                    <div class="text-center">
                        <b id="nombre_logo"> </b>
                    </div>
					...
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
										<h2>Gestion de portafolio</h2>
                                    </header>

                                    <!-- Content -->
                                        <div>
                                            <h2 id="content"></h2>
                                                <p>Aquí puede agregar información relacionada a <a href="./portafolio.php">Portafolio</a>.</p>
										</div>
                                </section>
                                <section>
                                    <div class="container-fluid">
                                        <div class="card card-success">
                                            <div class="card-header">
                                                <h3 class="card-title">Buscar o <button type="button" data-toggle ="modal" data-target="#crearporta" class="btn primary  ml-2">Crear artículo</button></h3>
                                                <div class="input-group">
                                                    <input type="text" id="buscar_portafolio"class="form-control float-left" placeholder="Ingrese el nombre del portafolio">
                                            ...
                                            <div class="card-body">
                                                <div id="portafolio" class="row d-flex align-items-stretch">
