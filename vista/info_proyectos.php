							...
							<!-- Content -->
								<section>
									<?php 
											...
											isset($_GET['id_proyecto']);
											//$resultado=$conexion->query("select * from proyectos where id_proyecto='".$_GET['id_proyecto']."';");
											$resultado=$conexion->query("select id_proyecto, nombre_proyecto, imagen, descripcion_proyecto, responsable, fecha_subida, nombres, apellidos,enlace_externo 
											from proyectos
											join usuarios on nombres=nombres and  apellidos = apellidos and responsable = id_usuario where id_proyecto='".$_GET['id_proyecto']."';");
											if(mysqli_num_rows($resultado)>0){
												while ($fila = mysqli_fetch_array($resultado)) {
									?>
									<header class="main">
									<h2><a href="./proyectos.php">Regresar a proyectos</a></h2><hr>
									</header>
									<h3 id="content"><?php echo $fila['nombre_proyecto'];?></h3>
									
										<div>
											<p><?php 
												echo nl2br($fila['descripcion_proyecto']);
											?> 
                                            <br><br><a href="<?php echo $fila['enlace_externo'];?> " target="_blank">Más Información.</a></p>
											<img src="../images/proyectos/<?php echo $fila['imagen'];?>" class="image img" width="600px">
