...
class Conexion{
    ...
    private $db="sistema_ingenieriasoft";
    private $puerto=3306;
    ...
    public function __construct(){
        $this->pdo = new PDO("mysql:dbname={$this->db};host={$this->servidor};port={$this->puerto}",$this->usuario,$this->contrasena,$this->atributos);
